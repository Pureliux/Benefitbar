...
const invalidResetMessage = 'Reset-Link ist ungültig oder abgelaufen. Bitte fordere einen neuen Link an.';
...
const ResetPasswordPage = () => {
  ...
  useEffect(() => {
    const checkToken = async () => {
      if (!token) {
        setErrorMsg(invalidResetMessage);
        setTokenValid(false);
  ...
  return (
    <>
      <Helmet>
        <title>Passwort ändern - Tchibo Benefit-Bar</title>
      </Helmet>
        ...
        <div className="max-w-md w-full">
          <div className="bg-card rounded-lg p-8 shadow-lg border border-border">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-foreground mb-2">Passwort ändern</h1>
